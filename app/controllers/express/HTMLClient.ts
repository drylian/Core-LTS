    ...
    <script>
        function loadContent() {
            ...
            .then(function (textContent) {
                ...
                function loadScriptAsync(scriptText, scriptId, scriptType) {
                    ...
                    if (scriptType) {
                        newScript.type = "module"; // Definir o atributo type, se fornecido
                    }
                ...
                scripts.forEach(function (script, index) {
                    // Verificar se o script tem um atributo "type"
                    loadScriptAsync(script.text, gen(12) + index, script.type ? true : false);
                });
